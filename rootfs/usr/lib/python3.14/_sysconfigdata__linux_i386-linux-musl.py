...
build_time_vars = {
    ...
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    'BUILD_GNU_TYPE': 'i586-alpine-linux-musl',
    ...
    'CONFIGURE_LDFLAGS_NODIST': '-Wl,--as-needed,-O1,--sort-common -Wl,-z,pack-relative-relocs -Wl,-z,stack-size=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g',
    'CONFIGURE_LDFLAGS_NOLTO': '-fno-lto',
    'CONFIG_ARGS': "'--build=i586-alpine-linux-musl' '--host=i586-alpine-linux-musl' '--prefix=/usr' '--enable-ipv6' '--enable-loadable-sqlite-extensions' '--enable-optimizations' '--enable-shared' '--with-lto' '--with-computed-gotos' '--with-dbmliborder=gdbm:ndbm' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' 'build_alias=i586-alpine-linux-musl' 'host_alias=i586-alpine-linux-musl' 'CC=cc'",
    ...
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-314-i386-linux-musl.so',
    'FILEMODE': 644,
    ...
    'HAVE___UINT128_T': 0,
    'HOSTRUNNER': '',
    'HOST_GNU_TYPE': 'i586-alpine-linux-musl',
    ...
    'LIBPL': '/usr/lib/python3.14/config-3.14-i386-linux-musl',
    'LIBPYTHON': '',
    ...
    'MULTIARCH': 'i386-linux-musl',
    'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"i386-linux-musl\\"',
    ...
    'PY_CORE_LDFLAGS': '-Wl,-z,stack-size=1048576 -Wl,--as-needed,-O1,--sort-common -Wl,-z,pack-relative-relocs -Wl,-z,stack-size=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -Wl,--as-needed,-O1,--sort-common -Wl,-z,pack-relative-relocs -Wl,-z,stack-size=0x200000',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-Wl,-z,stack-size=1048576',
    'PY_LDFLAGS_NODIST': '-Wl,--as-needed,-O1,--sort-common -Wl,-z,pack-relative-relocs -Wl,-z,stack-size=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -Wl,--as-needed,-O1,--sort-common -Wl,-z,pack-relative-relocs -Wl,-z,stack-size=0x200000',
    'PY_LDFLAGS_NOLTO': '-Wl,-z,stack-size=1048576 -fno-lto -Wl,--as-needed,-O1,--sort-common -Wl,-z,pack-relative-relocs -Wl,-z,stack-size=0x200000',
    ...
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-314-i386-linux-musl.so Modules/_asyncio.cpython-314-i386-linux-musl.so Modules/_bisect.cpython-314-i386-linux-musl.so Modules/_csv.cpython-314-i386-linux-musl.so Modules/_heapq.cpython-314-i386-linux-musl.so Modules/_json.cpython-314-i386-linux-musl.so Modules/_lsprof.cpython-314-i386-linux-musl.so Modules/_pickle.cpython-314-i386-linux-musl.so Modules/_queue.cpython-314-i386-linux-musl.so Modules/_random.cpython-314-i386-linux-musl.so Modules/_remote_debugging.cpython-314-i386-linux-musl.so Modules/_struct.cpython-314-i386-linux-musl.so Modules/_interpreters.cpython-314-i386-linux-musl.so Modules/_interpchannels.cpython-314-i386-linux-musl.so Modules/_interpqueues.cpython-314-i386-linux-musl.so Modules/_zoneinfo.cpython-314-i386-linux-musl.so Modules/math.cpython-314-i386-linux-musl.so Modules/cmath.cpython-314-i386-linux-musl.so Modules/_statistics.cpython-314-i386-linux-musl.so Modules/_decimal.cpython-314-i386-linux-musl.so Modules/binascii.cpython-314-i386-linux-musl.so Modules/_bz2.cpython-314-i386-linux-musl.so Modules/_lzma.cpython-314-i386-linux-musl.so Modules/zlib.cpython-314-i386-linux-musl.so Modules/_dbm.cpython-314-i386-linux-musl.so Modules/_gdbm.cpython-314-i386-linux-musl.so Modules/readline.cpython-314-i386-linux-musl.so Modules/_md5.cpython-314-i386-linux-musl.so Modules/_sha1.cpython-314-i386-linux-musl.so Modules/_sha2.cpython-314-i386-linux-musl.so Modules/_sha3.cpython-314-i386-linux-musl.so Modules/_blake2.cpython-314-i386-linux-musl.so Modules/_hmac.cpython-314-i386-linux-musl.so Modules/pyexpat.cpython-314-i386-linux-musl.so Modules/_elementtree.cpython-314-i386-linux-musl.so Modules/_codecs_cn.cpython-314-i386-linux-musl.so Modules/_codecs_hk.cpython-314-i386-linux-musl.so Modules/_codecs_iso2022.cpython-314-i386-linux-musl.so Modules/_codecs_jp.cpython-314-i386-linux-musl.so Modules/_codecs_kr.cpython-314-i386-linux-musl.so Modules/_codecs_tw.cpython-314-i386-linux-musl.so Modules/_multibytecodec.cpython-314-i386-linux-musl.so Modules/unicodedata.cpython-314-i386-linux-musl.so Modules/fcntl.cpython-314-i386-linux-musl.so Modules/grp.cpython-314-i386-linux-musl.so Modules/mmap.cpython-314-i386-linux-musl.so Modules/_posixsubprocess.cpython-314-i386-linux-musl.so Modules/resource.cpython-314-i386-linux-musl.so Modules/select.cpython-314-i386-linux-musl.so Modules/_socket.cpython-314-i386-linux-musl.so Modules/syslog.cpython-314-i386-linux-musl.so Modules/termios.cpython-314-i386-linux-musl.so Modules/_posixshmem.cpython-314-i386-linux-musl.so Modules/_multiprocessing.cpython-314-i386-linux-musl.so Modules/_ctypes.cpython-314-i386-linux-musl.so Modules/_curses.cpython-314-i386-linux-musl.so Modules/_curses_panel.cpython-314-i386-linux-musl.so Modules/_sqlite3.cpython-314-i386-linux-musl.so Modules/_ssl.cpython-314-i386-linux-musl.so Modules/_hashlib.cpython-314-i386-linux-musl.so Modules/xxsubtype.cpython-314-i386-linux-musl.so Modules/_xxtestfuzz.cpython-314-i386-linux-musl.so Modules/_testbuffer.cpython-314-i386-linux-musl.so Modules/_testinternalcapi.cpython-314-i386-linux-musl.so Modules/_testcapi.cpython-314-i386-linux-musl.so Modules/_testlimitedcapi.cpython-314-i386-linux-musl.so Modules/_testclinic.cpython-314-i386-linux-musl.so Modules/_testclinic_limited.cpython-314-i386-linux-musl.so Modules/_testimportmultiple.cpython-314-i386-linux-musl.so Modules/_testmultiphase.cpython-314-i386-linux-musl.so Modules/_testsinglephase.cpython-314-i386-linux-musl.so Modules/_ctypes_test.cpython-314-i386-linux-musl.so Modules/xxlimited.cpython-314-i386-linux-musl.so Modules/xxlimited_35.cpython-314-i386-linux-musl.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl',
    'SHLIB_SUFFIX': '.so',
    ...
    'SIZEOF_WCHAR_T': 4,
    'SIZEOF__BOOL': 1,
    'SOABI': 'cpython-314-i386-linux-musl',
